...
if __name__ == "__main__":
    ...
    parser.add_argument("--lr",help="The learning rate for the network.",default=5*10e-4)
    parser.add_argument("--n_epochs",help="The number of epochs to train for.",default=5)
    parser.add_argument("--batch_size",help="The batch size to use for training and validation.",default=32)
    parser.add_argument("--use_gpu",help="Whether or not to use the GPU if it exists.",default=False)
